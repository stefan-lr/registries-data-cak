(function(angular) {
	...
	.config(['$translateProvider', function($translateProvider) {
		...
		"menu.organization.title": "Zoznam združení",
		"menu.attorneyclerk.title": "Zoznam koncipientov",
		"menu.euattorney.title": "Zoznam eu advokátov",
		"menu.attorney.title": "Zoznam advokátov",
		"menu.new.lower.level": "Nový",
		"menu.new.lower.level.she": "Nová",
		"menu.new.lower.level.it": "Nové",
		...
		"schema.people.attorneyListedDate":"Dátum zápisu",
		"schema.people.birthID":"Rodné číslo nebo, datum narození",
		"schema.people.attorneyID":"Identifikační číslo advokáta",
		"schema.people.attorneyIDFromBarAssociation":"I.č. přidělené Komorou",
		"schema.people.residence":"Bydliště",
		"schema.people.street":"Ulica",
		"schema.people.houseNumberDescriptive":"Číslo popisné",
		"schema.people.houseNumberOrientation":"Číslo orientační",
		"schema.people.cityDistrict":"Část obce (města)",
		"schema.people.office":"Sídlo",
		"schema.people.organization":"Sdružení",
		"schema.people.organization.name":"Název",
		"schema.people.company":"Společnost, v níž vykonává advokacii",
		"schema.people.company.ic":"I.č. společnosti",
		"schema.people.company.name":"Název",
		"schema.people.otherInformation":"Ostatní údaje",
		"schema.people.listedByParagraph5":"Zapsán podle § 5a",
		"schema.people.countryOfAttorney":"Cizí stát oprávnění",
		"schema.people.foreignBranchByP10andP35":"Orgán státu (§10/§35)",
		"schema.people.attorneyApproach":"Způsob vykonávaní advokace",
		"schema.people.languages":"Jazykové znalosti",
		"schema.people.fine":"Uloženo opatření v kárném řízení",
	...
	$translateProvider.translations('cz', {
		...
		"menu.organization.title": "Seznam sdružení",
		"menu.attorneyclerk.title": "Seznam koncipientů",
		"menu.euattorney.title": "Seznam eu advokátů",
		"menu.attorney.title": "Seznam advokátů",
